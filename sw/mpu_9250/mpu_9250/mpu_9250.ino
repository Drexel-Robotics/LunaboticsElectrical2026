...
#define INTERVAL_MS_PRINT         1000 //1000 is the standard interval 
#define G                         9.80665 
...
{ 
    ...
    data = GYRO_FULL_SCALE_1000_DPS;
    i2c_write(MPU9250_IMU_ADDRESS, 27, &data, 1);
    
    data = ACC_FULL_SCALE_2G;
    i2c_write(MPU9250_IMU_ADDRESS, 28, &data, 1);
    
    data = 0x02;
    i2c_write(MPU9250_IMU_ADDRESS, 55, &data, 1);
    
    data = 0x01;
    i2c_write(MPU9250_IMU_ADDRESS, 56, &data, 1);
} 
...
{
  uint8_t isReady;
  i2c_read(MPU9250_IMU_ADDRESS, 58, &isReady, 1);
  return isReady & 0x01;
}
...
void readRawImu()
{
  ...
  i2c_read(MPU9250_IMU_ADDRESS, 59, buff, 14);
